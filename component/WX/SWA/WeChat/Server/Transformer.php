...
use MComponent\WX\SWA\WeChat\Message\News;
...
class Transformer
{
    ...
    public function transform($message)
    {
        ...
        $handle = 'transform' . substr($class, strlen('MComponent\WX\SWA\WeChat\Message\\'));
     ...
     *
     * @param array|\MComponent\WX\SWA\WeChat\Message\News $news
     *
     * @return array
     */
