...
use MComponent\WX\SWA\WeChat\Support\Url as UrlHelper;
...
class Payment
{
     ...
     *
     * @param string|\MComponent\WX\SWA\Socialite\AccessTokenInterface $accessToken
     * @param bool $json
     *
     * @return string|array
     */
     ...
     *
     * @return \MComponent\WX\SWA\WeChat\Payment\Notify
     */
