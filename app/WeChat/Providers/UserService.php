...
use WeChat\Utils\WeChat\User\Group;
use WeChat\Utils\WeChat\User\Tag;
use WeChat\Utils\WeChat\User\User;
 ...
 * Class UserService.
 */
class UserService implements ServiceProviderInterface
{
    /**
